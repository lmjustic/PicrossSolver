...
#   2. Files you want to include in your final submission cannot match the
#      test*.cpp pattern.

# Version 5 - 2017-04-29, Luke M. Justice (lmjustic@umich.edu)
#   * Personal revisions to be used for personal projects
...
# TODO
# Generally unsed for personal projects
